 ...
 */
public class HikeMapFragment extends Fragment implements LocationListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_hike_map, container, false);
    ...
    public static String encode(final ArrayList<LatLng> path) {
        long lastLat = 0;
        long lastLng = 0;
